...
<html lang="en">
    <head>
        ...
        <!-- www.RTCMultiConnection.org/changes-log/#v1.7 -->
        ...
        <div class="main">
            <div class="new-message" style="overflow: hidden;height: 250px;">
                ...
                <div class="user-activity">
                    ...
                    <p class="message">
                        Please Enter your room id: <input type="text" id="room-name" placeholder="" style="border: 1px solid rgb(253, 253, 253);box-shadow: inset 0 0 0 1px rgb(53, 52, 52);outline: 1px solid rgb(7, 7, 7);"><br />
                        <br/>
                        <small style="color: rgb(1, 170, 143);font-style: italic;font-weight: bold;"></small> <br /><br />
                    
                        Please Enter Your User Name: <input type="text" id="your-name" placeholder="" ><button id="continue">Continue</button>
                    </p>
                </div>
            </div>
            
            <div class="new-message" style="overflow: hidden;height: 0px;">
                <div class="user-info" style="height: 0%">
